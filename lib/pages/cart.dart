import 'package:flutter_look_good_assignment/helpers/style.dart';
...
import 'package:flutter_look_good_assignment/db/order.dart';
import 'package:flutter_look_good_assignment/widgets/custom_text.dart';
                            ...
                            children: <Widget>[
                              RichText(
                                text: TextSpan(children: [
                                  ...
                                  TextSpan(
                                      text:
                                          "\LKR. ${userProvider.userModel.cart[index].price} \n\n",
                                      style: TextStyle(
                                          color: black,
                                          fontSize: 18,
            ...
            children: <Widget>[
              RichText(
                text: TextSpan(children: [
                  ...
                  TextSpan(
                      text: " \LKR. ${userProvider.userModel.totalCartPrice}",
                      style: TextStyle(
                          color: black,
                          fontSize: 22,
