...
import 'package:flutter_look_good_assignment/provider/kidscat.dart';
import 'package:flutter_look_good_assignment/provider/ladiescat.dart';
import 'package:flutter_look_good_assignment/provider/menscat.dart';
import 'dart:async';
...
Future<void> main() async {
  ...
  runApp(MultiProvider(
    providers: [
      ...
      ChangeNotifierProvider.value(value: ProductProviderKids.initialize()),
      ChangeNotifierProvider.value(value: ProductProviderMens.initialize()),
      ChangeNotifierProvider.value(value: ProductProviderladies.initialize()),
    ],
    child: MaterialApp(
